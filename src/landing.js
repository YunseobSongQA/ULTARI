...
export function mountLanding(reel) {
   ...
   *
   * 기준은 넉넉히 잡습니다. 조금 넘친 것까지 상자로 만들면 끌 거리가
   * 몇십 px뿐인 덫이 생깁니다. 손가락은 그 덫에서 한 번 멈추고, 쓰는
   * 사람에게는 "중간에 걸렸다"로 느껴집니다. 그 정도는 넘치게 두는 편이
   * 낫습니다 — 아래가 조금 잘려도 붙잡히지는 않습니다. 정말 안 들어가는
   * 화면만 상자가 됩니다. 낮은 창의 치수는 CSS가 줄여 둡니다.
   */
  const SLACK = 96;
