...
/* 3등급은 1차 검사입니다.
   전에는 여기에 "확정 인증은 2등급부터입니다"를 적었습니다. 사실이긴 하지만,
   방금 통과한 사람에게 "당신이 받은 것은 진짜가 아니다"라고 말하는 줄이었습니다.
   그러면 3등급을 받을 이유가 화면에서 사라집니다.

   3등급이 하는 일은 분명합니다 — 기계가 걸러 낼 수 있는 것은 여기서 다
   걸러집니다. 그 사실을 적고, 더 볼 것이 남았다는 것은 안내로 돌립니다. */
export const STATEMENT_GRADE3 = [
  '이 사진은 실제 카메라로 촬영된 것으로 보입니다.',
  '기계가 가릴 수 있는 것은 여기서 다 걸렀습니다.',
  '무엇을 찍었는지까지는 사람이 봐야 압니다.',
];
